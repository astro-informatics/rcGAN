...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        cosmos_map = np.load('/home/jjwhit/rcGAN/mass_map_utils/cosmos/cosmos_shear_cropped.npy', allow_pickle=True)
        ...
        np.save(
            f"/share/gpu0/jjwhit/samples/real_output/cosmos/np_avgs_cos.npy",
            np_avgs["mmGAN"],
        )
        np.save(
            f"/share/gpu0/jjwhit/samples/real_output/cosmos/np_stds_cos.npy",
            np_stds["mmGAN"],
        )
        np.save(
            f"/share/gpu0/jjwhit/samples/real_output/cosmos/np_samps_cos.npy",
            np_samps["mmGAN"],
        )

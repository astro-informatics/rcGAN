...
class GriGAN(pl.LightningModule):
    def __init__(self, args, exp_name, num_gpus):
        ...
        self.generator = UNetModel(
            ...
            chans = 64, # half the original as otherwise it is doubled because of the gradients
